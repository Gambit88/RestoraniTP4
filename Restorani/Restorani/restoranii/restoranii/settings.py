"""
Django settings for restoranii project.
...
SECRET_KEY = '_sbb7_yxsgk8iz#=lryjjr^62tmeq+&3q7k^nwc#c_+@2cv6wq'
...
WSGI_APPLICATION = 'restoranii.wsgi.application'
